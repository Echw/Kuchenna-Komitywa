...
const WhySection = () => {
  ...
  return (
    <SectionContainer id="why" backgroundColor="var(--mantine-color-white)" ref={containerRef}>
      ...
      <div className={styles.why_points}>
        ...
        >
          ...
          />
          {["point1", "point2", "point3", "point4", "point5"].map((pointClass, index) => (
            <motion.g
              key={pointClass}
              className={styles[pointClass]}
              variants={pointVariants}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.5 }}
            >
              {/* Original point SVG paths from the original component */}
              {index === 0 && (
                <>
                  <path
